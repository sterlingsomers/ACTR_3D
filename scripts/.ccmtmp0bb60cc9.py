...
log=ccm.log(data=True,screen=False,directory="Experiment0_NoMotorInteferenceWalking_nonLinear_lessVisualInterference_AFalternate/RadiusMultiplier(1.9) MaximumRotationRate(0.08)")
model=MyModel()
