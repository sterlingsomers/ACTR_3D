...
class MotorMethods(ccm.ProductionSystem):
    production_time = 0.010
    #fake_buffer = Buffer()
    shoulder_rotation_rate = 3.85 * 0.0177
...
log=ccm.log(data=True,screen=False,directory="Experiment0_NoMotorInteferenceWalking_nonLinear_lessVisualInterference_AFalternate_modulated_LINEAR/RadiusMultiplier(1.9) MaximumRotationRate(0.08)")
model=MyModel()
