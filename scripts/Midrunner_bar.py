...
for agent in range(PopulationSize):
    ...
    for adict in stuffs(parameters):
        ...
        for i in range(Runs):
            ...
            timestr = timestr + '.pip'
            path = '/home/sterling/morse/projects/ACTR_3D/scripts/Midrunner_bar/'
            ...
            try:
                ...
                p = mp.Process(target=runpy.run_module, args=('LinearModel_Planned_LowLevel_bar',adict))
                p.start()
                p.join()
