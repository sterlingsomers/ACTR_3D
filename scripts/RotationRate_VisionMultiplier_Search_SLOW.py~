...
parameters = {'RadiusMultiplier':[2.5,3.0],
              'VisionMultiplier':[1.135,1.137,1.139,1.141,1.143],
              'ProductionSpeed':[0.025,0.050],
              'ApertureWidth':[40,55],
              'WalkingRate':[0.0128],
    ...
    for agent in range(PopulationSize):
        ...
        for adict in stuffs(parameters):
            for i in range(Runs):
                ...
                timestr = timestr + '.pip'
                path = '/home/sterling/morse/projects/ACTR_3D/scripts/RotationRate_VisionMultiplier_Search_SLOW/'
