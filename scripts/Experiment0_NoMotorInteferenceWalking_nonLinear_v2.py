...
class BottomUpVision(ccm.ProductionSystem):
    ...
    def detect_obstacles_three(b_vision_command='scan:obstacles get:obstacle_found alert_status:none',
        ...
        self.parent.b_operator.set(' confirmed:no operator:react isa:obstacle location:' + l)
        b_vision_command.clear()
        #goal.set('stop')
...
###########################
    ...
    def vision_scan_obstacle_left(b_plan_unit='planning_unit:walk_through_aperture',
                                  b_unit_task='unit_task:walk posture:standing',
                                  b_operator='operator:react isa:obstacle location:left confirmed:no'):

        motor_module.get_bounding_box()
        motor_module.request_bounding_box()
        motor_module.request('type:proprioception feature:bounding_box width:? depth:?',delay=0.01)
        b_operator.modify('confirmed:confirming')
    ...
    def vision_scan_obstacle_left_confirm(b_plan_unit='planning_unit:walk_through_aperture',
                                  b_unit_task='unit_task:walk posture:standing',
        ...
        b_motor.clear()
        b_operator.modify('confirmed:vision_confirming')
    ...
    def vision_scan_obstacle_left_confirm3(b_plan_unit='planning_unit:walk_through_aperture',
                                  b_unit_task='unit_task:walk posture:standing',
                                  b_operator='operator:react isa:obstacle location:left confirmed:vision_confirming',
                                  vision_module='error:True'):
    ...
    def vision_scan_obstacle_right(b_plan_unit='planning_unit:walk_through_aperture',
                                    b_unit_task='unit_task:walk posture:standing',
                                    b_operator='operator:react isa:obstacle location:right confirmed:no'):
