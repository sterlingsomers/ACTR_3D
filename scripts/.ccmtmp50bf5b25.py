...
log=ccm.log(data=True,screen=False,directory="Experiment0_NoMotorInteferenceWalking_nonLinear_lessVisualInterference_modulated/RadiusMultiplier(1.9)")
model=MyModel()
