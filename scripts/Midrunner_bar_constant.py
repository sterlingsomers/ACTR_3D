...
parameters = {'RadiusMultiplier':[3],
              ...
              #change for bar
              'VisionConstant':[0.06],
              'APRatio':[0.9],#1.1,1.0,0.9
              'BarRatio':[2.5],#2.5,1.5,1.0],
              'WalkingRate':[0.0128],#March5
...
for agent in range(PopulationSize):
    ...
    for adict in stuffs(parameters):
        ...
        for i in range(Runs):
            ...
            timestr = timestr + '.pip'
            path = '/home/sterling/morse/projects/ACTR_3D/scripts/Midrunner_bar_constant/'
