...
log=ccm.log(data=True,screen=False,directory="Experiment0_NoMotorInteferenceWalking_nonLinear_lessVisualInterference_AFalternate_slower/RadiusMultiplier(1.6) MaximumRotationRate(0.08)")
model=MyModel()
