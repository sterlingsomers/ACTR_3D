...
parameters = {'RadiusMultiplier':[3.0],#2.5
              'VisionMultiplier':[1.135],#Then this1.137],#,MaybeThis1.139],
              'ProductionSpeed':[0.01,0.025,0.050],
              'ApertureWidth':[40,55,70],
              'WalkingRate':[0.0128],
              'ShoulderRotationRate':[math.radians(100/100),math.radians(120/100),math.radians(140/100)]}
    ...
    for agent in range(PopulationSize):
        ...
        for adict in stuffs(parameters):
            for i in range(Runs):
                ...
                timestr = timestr + '.pip'
                path = '/home/sterling/morse/projects/ACTR_3D/scripts/Feb23Search/'
