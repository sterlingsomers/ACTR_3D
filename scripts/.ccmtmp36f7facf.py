...
log=ccm.log(data=True,screen=False,directory="Experiment0_NoMotorInteferenceWalking_nonLinear_lessVisualInterference_AFalternate/RadiusMultiplier(1.8) VisionMultiplier(1.1) MaximumRotationRate(0.055)")
model=MyModel()
