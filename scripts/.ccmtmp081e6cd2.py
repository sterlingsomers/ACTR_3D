...
class MotorMethods(ccm.ProductionSystem):
    ...
    def increase_rotation_abdomen_right(b_motor_command_abdomen='rotate:true direction:right', motor_module='busy:False'):
        ...
        self.shoulder_rotation_rate = self.shoulder_rotation_rate + (0.2825*0.0177)
        #if self.shoulder_rotation_rate >= self.maximum_rotation_rate:
        #    self.shoulder_rotation_rate = self.maximum_rotation_rate
        ##goal.set('stop')
...
log=ccm.log(data=True,screen=False,directory="Experiment0_NoMotorInteferenceWalking_nonLinear_lessVisualInterference_AFalternate_modulated/RadiusMultiplier(1.7) MaximumRotationRate(0.08)")
model=MyModel()
