...
log=ccm.log(data=True,screen=False,directory="Experiment0_NoMotorInteferenceWalking_nonLinear_lessVisualInterference/RadiusMultiplier(1.7) VisionMultiplier(1.3)")
model=MyModel()
