...
log=ccm.log(data=True,screen=False,directory="Experiment0_NoMotorInteferenceWalking_nonLinear_lessVisualInterference_modulated_planned/RadiusMultiplier(1.7)")
model=MyModel()
